...
public class SystemProperties {
  ...
  public SystemProperties(Properties frProperties, Properties trProperties, Properties prProperties,
      Properties facilityInstanceProperties, Properties mciProperties, Properties shrProperties,
      Properties fhirMappingProperties) {
  ...
  public String getTrValuesetUrl(String valueSetKeyName) {
    ...
    if (StringUtils.isBlank(valuesetName)) {
      throw new RuntimeException(
          "Could not identify valueset. Make sure tr properties has key:" + valueSetKeyName);
    }
  ...
  public String createValueSetUrlFor(String valuesetName) {
    String trBaseUrl = StringUtil.ensureSuffix(
        trProperties.getProperty(PropertyKeyConstants.TR_REFERENCE_PATH), "/");
    String trValueSetPathInfo = StringUtil.removePrefix(
        trProperties.getProperty(TR_VALUESET_PATH_INFO), "/");
  ...
  public HashMap<String, String> getMrsToFHIREncounterTypeMap() {
    String property = fhirMappingProperties.getProperty(
        MRS_ENCOUNTER_TYPE_TO_FHIR_ENCOUNTER_TYPE_MAP);
    return getMap(property);
  }

  public HashMap<String, String> getFhirToMrsEncounterTypeMap() {
    String property = fhirMappingProperties.getProperty(
        FHIR_ENCOUNTER_TYPE_TO_MRS_ENCOUNTER_TYPE_MAP);
    return getMap(property);
  }
