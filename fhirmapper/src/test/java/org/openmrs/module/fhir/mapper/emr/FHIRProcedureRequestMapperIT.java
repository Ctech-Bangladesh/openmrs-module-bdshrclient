...
//        EmrEncounter emrEncounter = mapOrder("encounterBundles/dstu2/encounterWithProcedureRequest.xml", ProcedureRequest.ProcedureRequestStatus.REQUESTED);
//
...
//        EmrEncounter emrEncounter = mapOrder("encounterBundles/dstu2/encounterWithProcedureRequestWithNotSyncedConcept.xml", ProcedureRequest.ProcedureRequestStatus.REQUESTED);
//
//        Set<Order> orders = emrEncounter.getOrders();
...
//
//        EmrEncounter emrEncounter = mapOrder("encounterBundles/dstu2/encounterWithExistingProcedureRequest.xml", existingEncounter, ProcedureRequest.ProcedureRequestStatus.REQUESTED);
//
//        Set<Order> orders = emrEncounter.getOrders();
//        assertTrue(orders.isEmpty());
//    }
...
//        assertEquals(NEW, existingOrder.getAction());
//
//        EmrEncounter emrEncounter = mapOrder("encounterBundles/dstu2/encounterWithSuspendedProcedureRequest.xml", existingEncounter, ProcedureRequest.ProcedureRequestStatus.SUSPENDED);
//
//        Set<Order> orders = emrEncounter.getOrders();
//        assertFalse(orders.isEmpty());
//        assertEquals(1, orders.size());
